...
function DashboardPage() {
  ...
  return (
    <div className="min-h-screen pb-16">
      <AppHeader title="Banking" userName={userName} userImage={userImage} />
      ...
      <main className="max-w-[600px] mx-auto px-5 pt-6 space-y-6">
        ...
        <div className="flex gap-3 animate-in stagger-2">
          ...
          <Link to="/accounts" className="flex-1 flex items-center justify-center gap-2 rounded-xl bg-[var(--color-surface-raised)] border border-[var(--color-border)] py-2.5 text-sm font-medium press-scale hover:bg-[var(--color-surface-sunken)] transition-colors">
